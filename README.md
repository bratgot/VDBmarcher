...
A real-time volume renderer that brings Houdini VDB files directly into Nuke's 2D compositing pipeline. Supports smoke, fire, explosions, clouds, and particle point clouds with physically-based lighting.
